...
void PreviewWalkingForm::on_button_positionmode_clicked(bool check)
{
  ROS_INFO("positionmode clicked");
  sendPWalkingCommand("positionmode");
}

void PreviewWalkingForm::on_button_torquemode_clicked(bool check)
{
  ROS_INFO("torquemode button clicked");
  sendPWalkingCommand("torquemode");
}
