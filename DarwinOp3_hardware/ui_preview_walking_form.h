...
public:
    ...
    QPushButton *button_positionmode;
    QPushButton *button_torquemode;
    ...
    void setupUi(QWidget *PreviewWalkingForm)
    {
        ...
        button_positionmode = new QPushButton(groupBox);
        button_positionmode->setObjectName(QStringLiteral("button_positionmode"));
        button_positionmode->setMinimumSize(QSize(100, 60));

        gridLayout_19->addWidget(button_positionmode, 8, 0, 1, 1);


        button_torquemode = new QPushButton(groupBox);
        button_torquemode->setObjectName(QStringLiteral("button_torquemode"));
        button_torquemode->setMinimumSize(QSize(100, 60));

        gridLayout_19->addWidget(button_torquemode, 8, 2, 1, 1);
    ...
    void retranslateUi(QWidget *PreviewWalkingForm)
    {
        ...
        button_positionmode->setText(QApplication::translate("PreviewWalkingform","PositionMode",0));
        button_torquemode->setText(QApplication::translate("PreviewWalkingform","TorqueMode",0));
