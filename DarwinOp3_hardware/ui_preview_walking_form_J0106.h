...
public:
    ...
    QPushButton *button_positionmode_on;
    QPushButton *button_torquemode_on;
    ...
    void setupUi(QWidget *PreviewWalkingForm)
    {
        ...
        button_positionmode_on = new QPushButton(groupBox);
        button_positionmode_on->setObjectName(QStringLiteral("button_positionmode_on"));
        button_positionmode_on->setMinimumSize(QSize(100, 60));

        gridLayout_19->addWidget(button_positionmode_on, 8, 0, 1, 1);


        button_torquemode_on = new QPushButton(groupBox);
        button_torquemode_on->setObjectName(QStringLiteral("button_torquemode_on"));
        button_torquemode_on->setMinimumSize(QSize(100, 60));

        gridLayout_19->addWidget(button_torquemode_on, 8, 2, 1, 1);
    ...
    void retranslateUi(QWidget *PreviewWalkingForm)
    {
        ...
        button_positionmode_on->setText(QApplication::translate("PreviewWalkingform","PositionMode",0));
        button_torquemode_on->setText(QApplication::traslate("PreviewWalkingform","TorqueMode",0));
